...
func TestAPIMyPostsList(t *testing.T) {
	...
	regA := `{"username":"alice","email":"a@example.com","password":"password123","age":20,"gender":"other","first_name":"Test","last_name":"User"}`
	...
	regB := `{"username":"bob","email":"b@example.com","password":"password123","age":20,"gender":"other","first_name":"Test","last_name":"User"}`
